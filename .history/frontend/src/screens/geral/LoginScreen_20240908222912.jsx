...
import { useUser } from '../../contexts/UserContext' // Certifique-se de que o caminho está correto

export default function LoginScreen({ navigation }) {
  const [email, setEmail] = useState('')
  const [password, setPassword] = useState('')
  const { setUser } = useUser() // Usando o hook useUser para gerenciar o estado do usuário

  const onLogin = () => {
    handleLogin(email, password, setUser, navigation)
  }
