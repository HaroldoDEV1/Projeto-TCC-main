...
export default function RegisterMedicineScreen({ navigation }) {
    ...
    const [bulaName, setBulaName] = useState('Nenhum PDF selecionado')
    ...
    const handleImagePick = async () => {
        try {
            ...
            if (result.type === 'success') {
                setImage(result) // Atualiza o estado com o arquivo de imagem selecionado
                setImageName(result.name) // Atualiza o nome do arquivo de imagem selecionado
                console.log('Imagem selecionada:', result) // Exibe informações sobre a imagem no console
            }
        } catch (error) {
    ...
    const handleBulaPick = async () => {
        try {
            ...
            if (result.type === 'success') {
                setBula(result) // Atualiza o estado com o arquivo PDF da bula selecionado
                setBulaName(result.name) // Atualiza o nome do arquivo PDF selecionado
                console.log('Bula selecionada:', result) // Exibe informações sobre o PDF no console
            }
        } catch (error) {
    ...
    // Chama a função handleRegister passando os dados do formulário e o arquivo selecionado
    const onRegister = () => {
