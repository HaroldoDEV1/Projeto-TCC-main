    ...
    const handleImagePick = async () => {
        try {
            ...
            if (result.type === 'success') {
                ...
                setImageName(result.name || extractFileName(result.uri)) // Atualiza o nome do arquivo de imagem
                console.log('Imagem selecionada:', result)
            } else if (result.type === 'cancel') {
                console.log('Seleção de imagem cancelada')
            } else {
                console.log('Tipo inesperado de resultado:', result.type)
            }
        } catch (error) {
    ...
    const handleBulaPick = async () => {
        try {
            ...
            if (result.type === 'success') {
                ...
                setBulaName(result.name || extractFileName(result.uri)) // Atualiza o nome do arquivo PDF
                console.log('Bula selecionada:', result)
            } else if (result.type === 'cancel') {
