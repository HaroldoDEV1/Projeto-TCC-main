    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <FlatList
                ...
                numColumns={2}
                renderItem={({ item }) => (
                    <Card style={styles.card} onPress={() => viewMedicineDetails(item._id, item.name, item.category, item.description, item.price)}>
                        ...
                        <Card.Content>
                            ...
                            <Paragraph style={styles.cardDescription}>{item.category}</Paragraph>
