import React, { useState, useEffect, useRef } from 'react' // Importa hooks e funções do React
...
import styles from '../../constants/styles/stylesHome' // Importa os estilos personalizados
import TopArea from '../../components/TopArea/TopArea' // Importa o componente TopArea
import Footer from '../../components/Footer/Footer' // Importa o componente Footer
import { Camera, useCameraDevices } from 'react-native-vision-camera' // Importa componentes e hooks da biblioteca Vision Camera
