...
import { Searchbar, Avatar, Badge, Menu, Divider, DefaultTheme, Provider as PaperProvider } from 'react-native-paper'
...
const menuTheme = {
  ...
  colors: {
    ...DefaultTheme.colors,
    primary: '#6200ee', // Cor primária para o Menu
    background: '#ffffff', // Cor de fundo do Menu
    surface: '#ffffff', // Cor da superfície do Menu
    text: '#000000', // Cor do texto no Menu
  },
}

export default function TopArea({ navigation, isAdmin }) { 
    ...
    <View style={styles.container}>
      <View style={styles.row}>
        ...
        <Menu
          ...
          theme={menuTheme} // Aplica o tema ao Menu
        >
