...
import { PdfViewer } from './src/screens/user/MedicineScreen'
...
import DictionaryTest from './src/screens/user/DictionaryTest'
    ...
    <PaperProvider theme={theme}>
      <NavigationContainer>
        <Stack.Navigator>
          ...
          <Stack.Screen name="TopArea" component={TopArea} options={{ headerShown: false }} />
          ...
          <Stack.Screen name="DictionaryTest" component={DictionaryTest} options={{ headerShown: false }} />
          ...
          <Stack.Screen name="PdfViewer" component={PdfViewer} options={{ title: 'Visualizador de PDF' }} />
